...
const AlertsList = props => {
  ...
  const alertTable = alertType => {
    const priceChangeStyle = {
      color: alertType === "BUY" ? "#e15241" : "#43aa05"
    };
    // filter by alertType
    const filteredAlertsList = alertsList
      ...
      .sort((a, b) =>
        a.alertType === "BUY" ? -a.change + b.change : a.change - b.change
      );
                ...
                <Table.Row key={a.id}>
                  ...
                  <Table.Cell>
                    <a
                      ...
                      href={
                        "https://www.binance.com/trade.html?symbol=" + a.pairing
                      }
                    >
                      <Icon name="linkify" />
                    </a>
  ...
  return (
    <div>
      ...
      {alertTable("BUY")} {alertTable("SELL")}
    </div>
  );
};
